...
type ShipmentServiceClient interface {
	...
	AddShipmentEvent(ctx context.Context, in *AddShipmentEventRequest, opts ...grpc.CallOption) (*ShipmentEventResponse, error)
...
func (c *shipmentServiceClient) AddShipmentEvent(ctx context.Context, in *AddShipmentEventRequest, opts ...grpc.CallOption) (*ShipmentEventResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ShipmentEventResponse)
...
type ShipmentServiceServer interface {
	...
	AddShipmentEvent(context.Context, *AddShipmentEventRequest) (*ShipmentEventResponse, error)
...
func (UnimplementedShipmentServiceServer) AddShipmentEvent(context.Context, *AddShipmentEventRequest) (*ShipmentEventResponse, error) {
